...
def train_final_model_wrapper(best_hp, X_train, y_train, X_validation, y_validation, X_test, y_test, batch_size=1024):
    return torch_gpu_processing.train_final_ae_model(
        best_hp,
